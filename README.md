...
- Contenedores y **Docker/Kubernetes**
- **Automatización con Ansible y Terraform**
- Seguridad en **sistemas Linux y Windows**
- Cloud computing (**AWS, Azure, GCP**)

## 👯 Busco colaborar en
- Proyectos de **automatización de sistemas**
- **Auditorías de seguridad y hardening**
- Integración de **DevOps y CI/CD**  

## 🤔 Busco ayuda con
- Optimización de **monitorización de sistemas**
- Implementación de **infraestructura como código**
- Solución de **problemas complejos de servidores y redes**

## 💬 Pregúntame sobre
- Administración de **Linux y Windows Server**
- **Redes, firewalls y VPNs**
- **Scripting en Bash, PowerShell y Python**
- Seguridad y **backup de sistemas**
...
- Me encanta **automatizar todo lo que puedo** para ahorrar tiempo y errores humanos.  
